...
import (
	...
	"github.com/student/marketing-service-backend/services/resource/internal/repository"
	"log"
	"net/http"
	"strconv"
)
...
func Create(w http.ResponseWriter, r *http.Request) {
	...
	resource := &internal.Resource{Link: requestBody.Link, Description: requestBody.Description,
