...
import (
	...
	"github.com/student/marketing-service-backend/services/service/internal/repository"
	"log"
	"net/http"
	"strconv"
)
...
func Create(w http.ResponseWriter, r *http.Request) {
	...
	service := &internal.Service{Description: requestBody.Description}
...
func Update(w http.ResponseWriter, r *http.Request) {
	...
	if err := repo.Update(id, requestBody.Description); err != nil {
